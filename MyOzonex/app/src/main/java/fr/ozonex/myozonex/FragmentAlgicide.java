...
public class FragmentAlgicide extends Fragment implements View.OnClickListener {
    ...
    // Tout orientations
    CheckBox checkBoxEtat;
    TextView texteDonneesAlgicide;
    TextView texteConso;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        checkBoxEtat = (CheckBox) view.findViewById(R.id.checkbox_etat);
        texteDonneesAlgicide = (TextView) view.findViewById(R.id.texte_donnees_algicide);
    ...
    public void update() {
        if ((view != null) && isAdded()) {
            ...
            consoAEteModifie(Donnees.instance().obtenirDateDebutConso(Donnees.Equipement.Algicide),
                    Donnees.instance().obtenirConsoVolume(Donnees.Equipement.Algicide),
                    Donnees.instance().obtenirConsoVolumeRestant(Donnees.Equipement.Algicide));
        }
    }
    ...
    private void modifierMode(RadioButton rb) {
        ...
        Donnees.instance().definirModeFonctionnement(Donnees.Equipement.Algicide, etat);
